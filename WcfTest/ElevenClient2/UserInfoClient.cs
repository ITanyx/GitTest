...
public interface IUserInfo
{
    ...
    ElevenService.User[] GetInfo(System.Nullable<int> id);
    ...
    ElevenService.User[] EndGetInfo(System.IAsyncResult result);
}
...
public partial class GetInfoCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
{
    ...
    public ElevenService.User[] Result
    {
        get
        {
            base.RaiseExceptionIfNecessary();
            return ((ElevenService.User[])(this.results[0]));
        }
    }
}
...
public partial class UserInfoClient : System.ServiceModel.ClientBase<IUserInfo>, IUserInfo
{
    ...
    public ElevenService.User[] GetInfo(System.Nullable<int> id)
    {
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    public ElevenService.User[] EndGetInfo(System.IAsyncResult result)
    {
    ...
    {
        ElevenService.User[] retVal = this.EndGetInfo(result);
        return new object[] {
                retVal};
    }
